      ...
      <div className="sidebar-items">
        ...
        {expanded && (
          <div className="sidebar-section">
            ...
            <div className="sidebar-item">
              <svg viewBox="0 0 24 24" height="24" width="24">
                <path d="M18,5V2H6v3H3v6l3.23,1.61c0.7,2.5,2.97,4.34,5.69,4.38L8,19v3h8v-3l-3.92-3.99c2.73-0.04,5-1.88,5.7-4.39L21,11V5 H18z M6,11.38l-2-1V6h2V11.38z M16,11.38V6h2v4.38L16,11.38z"></path>
              </svg>
              <span>Sports</span>
            </div>
          </div>
